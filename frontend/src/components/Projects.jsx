...
import { ExternalLink, Github, Code2, Layout, Database, BarChart3, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Projects = ({ projects }) => {
    ...
    const getProjectIcon = (tags) => {
        ...
        return <Code2 size={64} color="var(--primary-color)" strokeWidth={1} />;
    };
                            ...
                            <div className="project-img-placeholder">
                                {proj.image ? (
                                    <img
                                        ...
                                        alt={proj.title}
                                        style={{ width: '100%', height: '100%', objectFit: 'contain', backgroundColor: 'rgba(0,0,0,0.2)', cursor: 'pointer' }}
